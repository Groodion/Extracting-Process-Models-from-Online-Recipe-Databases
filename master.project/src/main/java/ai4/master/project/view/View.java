...
public class View extends Application {
	...
	public void setText(String text) {
		...
		for (String word : words) {
			...
			if(KeyWordDatabase.KWDB_GERMAN.findCookingAction(testW) != null) {
				label.setTextFill(Color.RED);
			} else if(KeyWordDatabase.KWDB_GERMAN.findIngredient(testW) != null) {
				if(KeyWordDatabase.KWDB_GERMAN.findIngredientGroup(testW) != null)
					label.setTextFill(Color.GREENYELLOW);
				else
					label.setTextFill(Color.GREEN);
			} else if(KeyWordDatabase.KWDB_GERMAN.findTool(testW) != null) {
