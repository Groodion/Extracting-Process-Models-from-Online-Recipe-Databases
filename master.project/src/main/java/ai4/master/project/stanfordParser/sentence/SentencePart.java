...
public class SentencePart extends PartialObject<SentencePart> {
	...
	/**
	 * Gibt zur�ck ob der Satzteil ein Verb beinhaltet
	 * @return
	 */
	...
	/**
	 * F�gt zwei Satzteile zu einem zusammen
	 * @return
	 */
	...
	/**
	 * L�scht die gespeicherten Textcombinationen des Ausdruckstesters, um Arbeitsspeicher frei zu machen.
	 * @return
	 */
